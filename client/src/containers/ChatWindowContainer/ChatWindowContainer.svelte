...
- The header, which contains the name of the chat the user is currently in. 
- The window where all of the messages occur.
- The input where the user types in their IconMessageSearch
